...
| 1 | Base matériel `@easyhf/hardware-db` | **en cours** — 63 entrées sourcées sur 22 séries, gardes par modèle dans le moteur ; validation des chiffres par Julien contre WWB |
