...
| 1 | Base matériel `@easyhf/hardware-db` | **en cours** — 63 entrées sourcées sur 22 séries, gardes par modèle et blocs WMAS (Spectera) dans le moteur (D-026) ; validation des chiffres par Julien contre WWB |
