...
installé (D-029). Le mode d'emploi complet, du clone du dépôt à la lecture du
rapport, est dans `docs/IMPORT-WWB.md`. L'outil lit la base d'équipements de WWB et sort les écarts,
